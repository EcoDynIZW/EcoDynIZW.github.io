...
<br>
If you are not familiar with R and RStudio, open RStudio and follow the steps shown here of how to wwrite scripts in R: [Intro to RStudio](https://github.com/EcoDynIZW/EcoDynIZW.github.io/tree/main/docs/teaching/L1_Intro_RStudio.pdf)
<br>
