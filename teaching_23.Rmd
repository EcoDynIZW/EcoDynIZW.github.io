...
<br>
The courses follow a logic order. The first introductory courses give an overview over handling data in R; we then introduce statistical analyses for various types of data, e.g. from spatial distribution models of single species via biodiversity analyses of community counts, towards analyses of population trends.
<br>
...
<br>
If you are not familiar with R and RStudio, open RStudio and follow the steps shown here of how to wwrite scripts in R: [Intro to RStudio](https://github.com/EcoDynIZW/EcoDynIZW.github.io/raw/teaching_23/img/teach/L1_Intro_RStudio.pdf)
<br>
----------------to DO correct linking ----------------------
<br>
A cool feature in RStudio: use the rainbow parentheses option. For this, go to: Tools --> Global Options --> Code --> Display: enable rainbow parentheses. It helps you visually with  closing brackets correctly for function calls and loops.

### Folder setup

We chose the following folder structure for our courses, which you may adopt. 
