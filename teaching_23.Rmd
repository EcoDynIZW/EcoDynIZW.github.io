...
<br>
If you are not familiar with R, open RStudio and follow the steps shown here: [Intro to RStudio](https://github.com/EcoDynIZW/EcoDynIZW.github.io/tree/main/docs/teaching/L1_Intro_RStudio.pdf)
<br>
----------------to DO correct linking ----------------------
<br>
A cool feature: use rainbow parentheses in RStudio. For this, go to: Tools --> Global Options --> Code --> Display: enable rainbow parentheses. It helps you visually with  closing brackets correctly for function calls and loops.

### Folder setup

We chose the following folder structure for our courses, which you may adopt. Create a main (root) folder named d6_teaching_collection, then create the subfolders (data, output, R) relative to this root-folder (= d6_teaching_collection). Create an R-project within this folder (e.g. d6_teaching_collection.Rproj).
<br>
