...
- For consistent style, we ask you to use our corporate [d6 theme](): `d6::theme_d6()`.
- At the end of a project, transfer [your repository](https://ecodynizw.github.io/guidelines.html#repository) to our [EcoDynIZW GitHub account](https://github.com/EcoDynIZW/).
...
- Plan regular meetings at least 3 months ahead (2 weeks for non-regular meetings). 
