...
The final step after your paper gets published is to create a GitHub repository. Please create one with the author(s) and the year as names and transfer the ownership to the ecodyn GitHub account. The repository should contain clean code and data that runs properly. In case of using R please use a R-Project with the given folder structure (see appendix A).
