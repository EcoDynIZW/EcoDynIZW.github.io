...
- Important lab information (server access, responsibilities,...) can be found on our cloud in the folder `Lab_Orga`.
- Follow our rules how to call project folders: `animal_species_where_what_who`.
- Create the project folder structure with our [d6 package](https://ecodynizw.github.io/posts/d6package/): `d6::new_project()`.
- At the end of a project, transfer [your repository](https://ecodynizw.github.io/guidelines.html#repository) to our [EcoDynIZW account](https://github.com/EcoDynIZW/).
- Ask Moritz Wenzler (<a href="mailto:wenzler@izw-berlin.de">wenzler[at]izw-berlin.de</a>) for help of needed.


### Information for Students (BSc | MSc | PhD)

#### Supervisory Meetings

- Plan regular meetings with your supervisor(s) at least 3 months ahead (2 weeks for non-regular meetings). 
- Prepare for the meeting! Think about open questions, difficulties encountered, and the timeline for upcoming tasks.
- Write the minutes of the meeting and send it to your supervisor(s).


#### Thesis writing

- Start writing your thesis early enough.
- Attend writing courses.
- Regularly send your chapter drafts to your supervisor(s) to get feedback. Allow for sufficient time to read and respond (1-3 weeks).
- Send the final version of your manuscript/thesis to all supervisors/colleagues at least 4 weeks before the submission date. Keep in mind that you have to revise it afterwards!
</div>
