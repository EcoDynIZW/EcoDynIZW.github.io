...
* **Use the standardized project folder** structure! (see Appendix A, cf. [`d6` R package](https://github.com/EcoDynIZW/d6) and [GitHub](https://github.com/))
