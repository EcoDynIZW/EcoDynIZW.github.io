...
For information on the Department, check [our webpage](https://www.ecological-dynamics-izw.com) (https://www.ecological-dynamics-izw.com) or subscribe to [our Twitter account](https://www.twitter.com/EcoDynIZW) (@EcoDynIZW) for news about papers, helpful R-code, courses or scientific positions.
...
*	If possible, use dynamic paths (i.e. see R-package [`here`](https://here.r-lib.org/) (https://here.r-lib.org/)).
...
*	Stick to the [Rstudio style guide](https://style.tidyverse.org/index.html) (https://style.tidyverse.org/index.html) to ensure readability of code. 
...
A new project can be started by installing the [d6 R-package](https://github.com/EcoDynIZW/d6) (https://github.com/EcoDynIZW/d6). Running `new_project()` with a unique and descriptive name for your project (see below) will create a full scaffolding structure for all your future analysis steps. If you like, you can also specify a path and the project will be created there. 
...
```{r echo=FALSE, out.width='100%', fig.cap="Common project folder strucuture used in the Department of Ecological Dynamics."}
knitr::include_graphics("img/folder_structure_d6_projects.png")
```
