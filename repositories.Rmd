...
<li class="card-repo">
  ...
  <li class="card-repo">
    ...
    <h3>Sollmann 2024</h3>
    <p>Mt or not Mt: Temporal variation in detection probability in spatial capture-recapture and occupancy models. *BIORXIV*</p><p>
    <a href='https://doi.org/10.1101/2023.08.08.552394'>![](img/repo/icon-paper.png){width=12%}</a> 
