...
<ul class="card-wrapper">
  ...
  <li class="card-repo">
    <img class="card-repo-img" src='img/repo/caro_2023.png' alt='Meta- and subpopulation estimation with disparate data: coconut crabs in the Western Indian Ocean.'>
    ...
    <a href='https://github.com/rasrage/Coconut-crabs'>![](img/repo/icon-github.png){width=12%}</a>
