...
<ul class="card-wrapper">
  <li class="card-repo">
    <img class="card-repo-img" src='img/repo/alexiou_2024_wildl_biol.jpg' alt='
Figure 1: Study area map of Nakai-Nam Theun National Park, Laos. Camera trapping was conducted in three different biodiversity management zones between February to August 2020. Cameras were placed on the field using a 2.5 km grid.'>
