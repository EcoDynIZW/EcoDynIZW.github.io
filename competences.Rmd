...
![](img/hex_isorix.png){width=20%} ![](img/hex_nlmr-2.png){width=20%} ![](img/hex_camtrapr.png){width=20%}
![](img/hex_deepforest_v3-1.png){width=40%} ![](img/hex_vietnameseconverter.png){width=40%} 
