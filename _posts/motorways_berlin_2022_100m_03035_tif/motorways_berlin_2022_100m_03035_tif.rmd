...
# get path
path <-
    paste0(ifelse(dir.exists('E:/PopDynCloud') == T, 'E:/PopDynCloud', 'C:/PopDynCloud'), '/GeoData/data-proc/berlin/motorways_berlin_2022_100m_03035_tif')
...
```{r map}
p_map <-
 readRDS(paste0(ifelse(dir.exists('E:/PopDynCloud') == T, 'E:/PopDynCloud', 'C:/PopDynCloud'), '/', 'GeoData/data-proc/berlin/motorways_berlin_2022_100m_03035_tif/motorways_berlin_2022_100m_03035_tif', '.rds'))
