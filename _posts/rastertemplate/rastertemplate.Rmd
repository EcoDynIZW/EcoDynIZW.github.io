...
description: |
  Learn how to get a raster template from the `{d6geodata}` package and how to multiple/expand it. In the end we will rasterize vector data with the expanded raster.
