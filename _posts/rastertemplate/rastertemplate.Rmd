...
description: |
  Learn how to get a raster template from the `{d6geodata}` package and how to multiple/expand it. This will help you tranform your vector data to your disired raster resolution and extent. In the end we will rasterize vector data with the expanded raster to get information of your vector data like gps point or tracks.
...
ext_tab <- terra::extract(x = temp_rast, # template raster as first input
               ...
               ID=TRUE # and the id infront of each row
               )
```
