...
- open-access
- the d6berlin package provides utility functions to download FIS-Broker data: `download_fisbroker_wfs` (vector data) and `download_fisbroker_atom` (raster data)
