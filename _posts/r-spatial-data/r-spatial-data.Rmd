...
preview: https://raw.githubusercontent.com/EcoDynIZW/EcoDynIZW.github.io/main/img/rnaturalearth-glaciers-large.png
categories:
  - tutorial
  - rstats
  - workflow
...
small <- ggplot() + 
  ...
  geom_sf(data = glacier_small, color = "grey40", fill = "grey40") + 
  coord_sf(crs = "+proj=eqearth") +
  labs(title = 'type = "glaciated_areas", category = "physical", scale = "small"')

large <- ggplot() +
  geom_sf(data = world, color = "grey85", fill = "grey85", lwd = .05) +
  geom_sf(data = glacier_large, color = "grey40", fill = "grey40") +
  coord_sf(crs = "+proj=eqearth") + 
  labs(title = 'type = "glaciated_areas", category = "physical", scale = "large"')
...
ggplot(beekeper_locations) + 
  geom_sf(data = sf_berlin, fill = "grey10", color = "grey20") +
