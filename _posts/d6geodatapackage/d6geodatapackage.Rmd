...
<code>d6geodata::get_overview(path_to_cloud = "E:/PopDynCloud")</code>
...
p_base_map <- ggplot2::ggplot() +
              stars::geom_stars(data = stars::st_as_stars(tif)) +
              ggplot2::coord_sf(expand = FALSE) 

plot_binary_map(tif = tif, p_base_map = p_base_map)
plot_qualitative_map(tif = tif, p_base_map = p_base_map)
plot_quantitative_map(tif = tif, p_base_map = p_base_map)
```
...
library(d6geodata)
p_base_map <- ggplot2::ggplot() +
              stars::geom_stars(data = stars::st_as_stars(corine)) +
              ggplot2::coord_sf(expand = FALSE) 

plot_qualitative_map(tif = corine, p_base_map = p_base_map)
```
