---
title: 'distance-to-motorway-rural-road germany 2022'
categories:
  - distance
  - Germany
  - '2022'
...
# get path
path <-
    paste0(ifelse(dir.exists('E:/PopDynCloud') == T, 'E:/PopDynCloud', 'C:/PopDynCloud'),  '/',  'GeoData/data-proc/germany/distance-to-motorway-rural-road_germany_2022_100m_03035_tif')
...
```{r map}
p_map <-
 readRDS(paste0(ifelse(dir.exists('E:/PopDynCloud') == T, 'E:/PopDynCloud', 'C:/PopDynCloud'), '/', 'GeoData/data-proc/germany/distance-to-motorway-rural-road_germany_2022_100m_03035_tif/distance-to-motorway-rural-road_germany_2022_100m_03035_tif' ,'.rds'))
