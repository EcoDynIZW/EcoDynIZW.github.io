---
title: 'distance-to-rivers atlas 2009'
categories:
  - Atlas
  - '2022'
  - 1m
...
# get path
path <-
    paste0(ifelse(dir.exists('E:/PopDynCloud') == T, 'E:/PopDynCloud', 'C:/PopDynCloud'),  '/',  'GeoData/data-proc/atlas/distance-to-rivers_atlas_2009_1m_03035_tif')
...
```{r map}
p_map <-
 readRDS(paste0(ifelse(dir.exists('E:/PopDynCloud') == T, 'E:/PopDynCloud', 'C:/PopDynCloud'), '/', 'GeoData/data-proc/atlas/distance-to-rivers_atlas_2009_1m_03035_tif/distance-to-rivers_atlas_2009_1m_03035_tif' ,'.rds'))
