---
title: 'distance-to-waterbodies atlas-gross-kreutz 2009'
categories:
  - Atlas-Gross-Kreutz
  - '2009'
  - 1m
...
path <-
    ...
    ifelse(dir.exists('C:/PopDynCloud') == T, 'C:/PopDynCloud', 'E:/PopDynCloud')),  '/',  'GeoData/data/atlas-gross-kreutz/distance-to-waterbodies_atlas-gross-kreutz_2009_1m_03035_tif')
...
p_map <-
 readRDS(paste0(ifelse(dir.exists('T:/wenzler') == T, 'T:/wenzler',
    ifelse(dir.exists('C:/PopDynCloud') == T, 'C:/PopDynCloud', 'E:/PopDynCloud')),  '/',  'GeoData/data/atlas-gross-kreutz/distance-to-waterbodies_atlas-gross-kreutz_2009_1m_03035_tif/distance-to-waterbodies_atlas-gross-kreutz_2009_1m_03035_tif' ,'.rds'))
