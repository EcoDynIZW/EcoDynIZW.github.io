---
title: 'small-woody-features europe 2018'
categories:
  - Europe
  - epsg:3035
  - 100m
...
# get path
path <-
    paste0(ifelse(dir.exists('E:/PopDynCloud') == T, 'E:/PopDynCloud', 'C:/PopDynCloud'),  '/',  'GeoData/data-raw/europe/small-woody-features_europe_2018_100m_03035_tif')
...
```{r map}
p_map <-
 readRDS(paste0(ifelse(dir.exists('E:/PopDynCloud') == T, 'E:/PopDynCloud', 'C:/PopDynCloud'), '/', 'GeoData/data-raw/europe/small-woody-features_europe_2018_100m_03035_tif/small-woody-features_europe_2018_100m_03035_tif' ,'.rds'))
