---
title: 'imperviousness berlin 2021'
categories:
...
# get path
path <-
    paste0(ifelse(dir.exists('T:wenzler') == T, 'T:wenzler', 'C:/PopDynCloud'),  '/',  'GeoData/data/berlin/imperviousness_berlin_2021_polygon_03035_gpkg')
...
```{r map}
p_map <-
 readRDS(paste0(ifelse(dir.exists('T:wenzler') == T, 'T:wenzler', 'C:/PopDynCloud'), '/', 'GeoData/data/berlin/imperviousness_berlin_2021_polygon_03035_gpkg/imperviousness_berlin_2021_polygon_03035_gpkg' ,'.rds'))
