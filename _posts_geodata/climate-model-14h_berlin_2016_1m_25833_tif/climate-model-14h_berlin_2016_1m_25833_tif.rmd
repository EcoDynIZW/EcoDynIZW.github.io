---
title: 'climate-model-14h berlin 2016'
categories:
  - Berlin
  - '2016'
  - temperature
...
# get path
path <-
    paste0(ifelse(dir.exists('E:/PopDynCloud') == T, 'E:/PopDynCloud', 'C:/PopDynCloud'),  '/',  'GeoData/data/berlin/climate-model-14h_berlin_2016_1m_25833_tif')
...
```{r map}
p_map <-
 readRDS(paste0(ifelse(dir.exists('E:/PopDynCloud') == T, 'E:/PopDynCloud', 'C:/PopDynCloud'), '/', 'GeoData/data/berlin/climate-model-14h_berlin_2016_1m_25833_tif/climate-model-14h_berlin_2016_1m_25833_tif' ,'.rds'))
