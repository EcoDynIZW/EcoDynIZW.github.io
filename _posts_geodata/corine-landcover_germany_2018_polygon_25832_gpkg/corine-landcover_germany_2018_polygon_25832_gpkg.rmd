---
title: 'corine-landcover germany 2018'
categories:
  - Germany
  - '2018'
  - polygon
...
path <-
    ...
    ifelse(dir.exists('C:/PopDynCloud') == T, 'C:/PopDynCloud', 'E:/PopDynCloud')),  '/',  'GeoData/data/germany/corine-landcover_germany_2018_polygon_25832_gpkg')
...
p_map <-
 readRDS(paste0(ifelse(dir.exists('T:/wenzler') == T, 'T:/wenzler',
    ifelse(dir.exists('C:/PopDynCloud') == T, 'C:/PopDynCloud', 'E:/PopDynCloud')),  '/',  'GeoData/data/germany/corine-landcover_germany_2018_polygon_25832_gpkg/corine-landcover_germany_2018_polygon_25832_gpkg' ,'.rds'))
