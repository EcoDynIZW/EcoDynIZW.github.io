---
title: 'population-density berlin 2019'
categories:
  - '2019'
  - Berlin
  - 10m
...
# get path
path <-
    paste0(ifelse(dir.exists('E:/PopDynCloud') == T, 'E:/PopDynCloud', 'C:/PopDynCloud'),  '/',  'GeoData/data-proc/berlin/population-density_berlin_2019_10m_03035_tif')
...
```{r map}
p_map <-
 readRDS(paste0(ifelse(dir.exists('E:/PopDynCloud') == T, 'E:/PopDynCloud', 'C:/PopDynCloud'), '/', 'GeoData/data-proc/berlin/population-density_berlin_2019_10m_03035_tif/population-density_berlin_2019_10m_03035_tif' ,'.rds'))
