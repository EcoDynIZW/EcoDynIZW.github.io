---
title: 'administrativ-units germany 2020'
categories:
  - Germany
  - '2020'
  - polygon
...
path <-
    ...
    ifelse(dir.exists('C:/PopDynCloud') == T, 'C:/PopDynCloud', 'E:/PopDynCloud')),  '/',  'GeoData/data/germany/administrativ-units_germany_2020_polygon_28532_gpkg')
...
p_map <-
 readRDS(paste0(ifelse(dir.exists('T:/wenzler') == T, 'T:/wenzler',
    ifelse(dir.exists('C:/PopDynCloud') == T, 'C:/PopDynCloud', 'E:/PopDynCloud')),  '/',  'GeoData/data/germany/administrativ-units_germany_2020_polygon_28532_gpkg/administrativ-units_germany_2020_polygon_28532_gpkg' ,'.rds'))
