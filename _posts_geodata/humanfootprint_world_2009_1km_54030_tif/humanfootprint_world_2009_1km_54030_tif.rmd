---
title: 'humanfootprint world 2009'
categories:
  - World
  - 1km
  - esri:54009
...
path <-
    ...
    ifelse(dir.exists('C:/PopDynCloud') == T, 'C:/PopDynCloud', 'E:/PopDynCloud')),  '/',  'GeoData/data/world/humanfootprint_world_2009_1km_54030_tif')
...
p_map <-
 readRDS(paste0(ifelse(dir.exists('T:/wenzler') == T, 'T:/wenzler',
    ifelse(dir.exists('C:/PopDynCloud') == T, 'C:/PopDynCloud', 'E:/PopDynCloud')),  '/',  'GeoData/data/world/humanfootprint_world_2009_1km_54030_tif/humanfootprint_world_2009_1km_54030_tif' ,'.rds'))
