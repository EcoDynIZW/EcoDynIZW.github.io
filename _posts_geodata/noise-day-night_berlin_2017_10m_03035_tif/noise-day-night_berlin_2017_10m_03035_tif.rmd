---
title: 'noise-day-night berlin 2017'
categories:
  - Berlin
  - '2017'
  - noise
...
# get path
path <-
    paste0(ifelse(dir.exists('E:/PopDynCloud') == T, 'E:/PopDynCloud', 'C:/PopDynCloud'),  '/',  'GeoData/data-proc/berlin/noise-day-night_berlin_2017_10m_03035_tif')
...
```{r map}
p_map <-
 readRDS(paste0(ifelse(dir.exists('E:/PopDynCloud') == T, 'E:/PopDynCloud', 'C:/PopDynCloud'), '/', 'GeoData/data-proc/berlin/noise-day-night_berlin_2017_10m_03035_tif/noise-day-night_berlin_2017_10m_03035_tif' ,'.rds'))
