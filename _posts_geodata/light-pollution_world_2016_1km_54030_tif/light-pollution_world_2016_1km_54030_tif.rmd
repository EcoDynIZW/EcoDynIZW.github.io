---
title: 'light-pollution world 2016'
categories:
  - World
  - 1km
  - esri:54009
...
path <-
    ...
    ifelse(dir.exists('C:/PopDynCloud') == T, 'C:/PopDynCloud', 'E:/PopDynCloud')),  '/',  'GeoData/data/world/light-pollution_world_2016_1km_54030_tif')
...
p_map <-
 readRDS(paste0(ifelse(dir.exists('T:/wenzler') == T, 'T:/wenzler',
    ifelse(dir.exists('C:/PopDynCloud') == T, 'C:/PopDynCloud', 'E:/PopDynCloud')),  '/',  'GeoData/data/world/light-pollution_world_2016_1km_54030_tif/light-pollution_world_2016_1km_54030_tif' ,'.rds'))
