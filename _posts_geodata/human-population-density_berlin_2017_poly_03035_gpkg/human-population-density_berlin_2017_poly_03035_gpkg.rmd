---
title: 'human-population-density berlin 2017'
categories:
  - Berlin
  - '2017'
  - Polygon
...
# get path
path <-
    paste0(ifelse(dir.exists('E:/PopDynCloud') == T, 'E:/PopDynCloud', 'C:/PopDynCloud'),  '/',  'GeoData/data/berlin/human-population-density_berlin_2017_poly_03035_gpkg')
...
```{r map}
p_map <-
 readRDS(paste0(ifelse(dir.exists('E:/PopDynCloud') == T, 'E:/PopDynCloud', 'C:/PopDynCloud'), '/', 'GeoData/data/berlin/human-population-density_berlin_2017_poly_03035_gpkg/human-population-density_berlin_2017_poly_03035_gpkg' ,'.rds'))
