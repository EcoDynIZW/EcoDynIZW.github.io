---
title: 'distance-to-streets atlas-gross-kreutz 2022'
categories:
  - Atlas-Gross-Kreutz
  - '2022'
  - 1m
...
path <-
    ...
    ifelse(dir.exists('C:/PopDynCloud') == T, 'C:/PopDynCloud', 'E:/PopDynCloud')),  '/',  'GeoData/data/atlas-gross-kreutz/distance-to-streets_atlas-gross-kreutz_2022_1m_03035_tif')
...
p_map <-
 readRDS(paste0(ifelse(dir.exists('T:/wenzler') == T, 'T:/wenzler',
    ifelse(dir.exists('C:/PopDynCloud') == T, 'C:/PopDynCloud', 'E:/PopDynCloud')),  '/',  'GeoData/data/atlas-gross-kreutz/distance-to-streets_atlas-gross-kreutz_2022_1m_03035_tif/distance-to-streets_atlas-gross-kreutz_2022_1m_03035_tif' ,'.rds'))
