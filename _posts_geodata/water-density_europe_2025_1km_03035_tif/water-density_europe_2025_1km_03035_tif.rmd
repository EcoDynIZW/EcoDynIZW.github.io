---
title: 'water-density europe 2025'
categories:
  - Europe
  - 1km
  - epsg:3035
...
path <-
    ...
    ifelse(dir.exists('C:/PopDynCloud') == T, 'C:/PopDynCloud', 'E:/PopDynCloud')),  '/',  'GeoData/data/europe/water-density_europe_2025_1km_03035_tif')
...
p_map <-
 readRDS(paste0(ifelse(dir.exists('T:/wenzler') == T, 'T:/wenzler',
    ifelse(dir.exists('C:/PopDynCloud') == T, 'C:/PopDynCloud', 'E:/PopDynCloud')),  '/',  'GeoData/data/europe/water-density_europe_2025_1km_03035_tif/water-density_europe_2025_1km_03035_tif' ,'.rds'))
