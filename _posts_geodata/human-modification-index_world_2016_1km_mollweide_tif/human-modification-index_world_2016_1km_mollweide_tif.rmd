---
title: 'human-modification-index world 2016'
categories:
  - World
  - 1km
  - crs:mollweide
...
# get path
path <-
    paste0(ifelse(dir.exists('E:/PopDynCloud') == T, 'E:/PopDynCloud', 'C:/PopDynCloud'),  '/',  'GeoData/data-raw/world/human-modification-index_world_2016_1km_mollweide_tif')
...
```{r map}
p_map <-
 readRDS(paste0(ifelse(dir.exists('E:/PopDynCloud') == T, 'E:/PopDynCloud', 'C:/PopDynCloud'), '/', 'GeoData/data-raw/world/human-modification-index_world_2016_1km_mollweide_tif/human-modification-index_world_2016_1km_mollweide_tif' ,'.rds'))
