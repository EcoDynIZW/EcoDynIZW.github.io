...
# get path
path <-
    paste0(ifelse(dir.exists('T:wenzler') == T, 'T:wenzler', 'C:/PopDynCloud'),  '/',  'GeoData/data/berlin/landuse_berlin_2021_polygon_03035_gpkg')
...
```{r map}
p_map <-
 readRDS(paste0(ifelse(dir.exists('T:wenzler') == T, 'T:wenzler', 'C:/PopDynCloud'), '/', 'GeoData/data/berlin/landuse_berlin_2021_polygon_03035_gpkg/landuse_berlin_2021_polygon_03035_gpkg' ,'.rds'))
