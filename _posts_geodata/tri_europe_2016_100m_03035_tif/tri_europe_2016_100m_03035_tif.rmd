...
```{r map}
p_map <-
 readRDS(paste0(ifelse(dir.exists('E:/PopDynCloud') == T, 'E:/PopDynCloud', 'C:/PopDynCloud'), '/', 'GeoData/data-proc/europe/tri_europe_2016_100m_03035_tif/tri_europe_2016_100m_03035_tif_interactive' ,'.rds'))

```

```{r plot, layout='l-screen-inset shaded'}
p_map
meta_gt
```
