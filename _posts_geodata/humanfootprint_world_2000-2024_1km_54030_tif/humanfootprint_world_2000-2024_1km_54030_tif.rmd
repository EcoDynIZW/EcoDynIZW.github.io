---
title: 'humanfootprint world 2000-2024'
categories:
  - World
  - 1km
  - esri:54030
...
path <-
    ...
    ifelse(dir.exists('C:/PopDynCloud') == T, 'C:/PopDynCloud', 'E:/PopDynCloud')),  '/',  'GeoData/data/world/humanfootprint_world_2000-2024_1km_54030_tif')
...
p_map <-
 readRDS(paste0(ifelse(dir.exists('T:/wenzler') == T, 'T:/wenzler',
    ifelse(dir.exists('C:/PopDynCloud') == T, 'C:/PopDynCloud', 'E:/PopDynCloud')),  '/',  'GeoData/data/world/humanfootprint_world_2000-2024_1km_54030_tif/humanfootprint_world_2000-2024_1km_54030_tif' ,'.rds'))
