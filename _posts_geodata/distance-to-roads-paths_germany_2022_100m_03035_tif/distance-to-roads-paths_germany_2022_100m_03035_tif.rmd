---
title: 'distance-to-roads-paths germany 2022'
categories:
  - Germany
  - '2022'
  - 100m
...
# get path
path <-
    paste0(ifelse(dir.exists('E:/PopDynCloud') == T, 'E:/PopDynCloud', 'C:/PopDynCloud'),  '/',  'GeoData/data-proc/germany/distance-to-roads-paths_germany_2022_100m_03035_tif')
...
```{r map}
p_map <-
 readRDS(paste0(ifelse(dir.exists('E:/PopDynCloud') == T, 'E:/PopDynCloud', 'C:/PopDynCloud'), '/', 'GeoData/data-proc/germany/distance-to-roads-paths_germany_2022_100m_03035_tif/distance-to-roads-paths_germany_2022_100m_03035_tif' ,'.rds'))
