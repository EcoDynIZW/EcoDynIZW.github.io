...
<ul class="card-wrapper">
  <li class="card">
### [Understand how species distributions shift in response to landcover change and poaching](team-biodiversity-roshan.html)&ensp;
  </li>


  <li class="card">
### [Wildlife communities in mixed land-use landscapes](team-biodiversity-seth.html)&ensp;
  </li>
</ul>
...
<ul class="card-wrapper">
  <li class="card">
### [Community structure and landscape-scale distribution of ground-dwelling mammals and birds in the Annamites: setting conservation priorities in a biodiversity hotspot](team-biodiversity-an.html)&ensp;
  </li>
</ul>
...
<ul class="card-wrapper">
  <li class="card">
### [Pantropical assessment of tropical forest mammal biodiversity](team-biodiversity-badru.html)&ensp;
  </li>
</ul>
